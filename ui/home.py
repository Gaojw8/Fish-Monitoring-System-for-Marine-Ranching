...
################################################################################
## Form generated from reading UI file 'homeGxWOsr.ui'
##
...
"        }")
        ...
        self.horizontalLayout_41 = QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_41.setObjectName(u"horizontalLayout_41")
        self.horizontalLayout_41.setContentsMargins(0, 0, 0, 0)
        self.layoutWidget1 = QWidget(self.home)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(-180, 170, 1546, 302))
        self.horizontalLayout_25 = QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout_25.setObjectName(u"horizontalLayout_25")
        self.horizontalLayout_25.setContentsMargins(0, 0, 0, 0)
        self.pushButton_classify = QPushButton(self.layoutWidget1)
...
"}")
        ...
        self.horizontalLayout_25.addWidget(self.pushButton_classify)

        self.pushButton_detect = QPushButton(self.layoutWidget1)
...
"}")
        ...
        self.horizontalLayout_25.addWidget(self.pushButton_detect)

        self.pushButton_forcast = QPushButton(self.layoutWidget1)
        self.pushButton_forcast.setObjectName(u"pushButton_forcast")
        sizePolicy.setHeightForWidth(self.pushButton_forcast.sizePolicy().hasHeightForWidth())
        self.pushButton_forcast.setSizePolicy(sizePolicy)
        self.pushButton_forcast.setMinimumSize(QSize(200, 200))
        self.pushButton_forcast.setMaximumSize(QSize(16777215, 16777215))
        self.pushButton_forcast.setLayoutDirection(Qt.LeftToRight)
        self.pushButton_forcast.setStyleSheet(u"QPushButton{\n"
...
"background-color: rgba(114, 129, 214, 59);\n"
"}")
        self.pushButton_forcast.setIconSize(QSize(300, 300))

        self.horizontalLayout_25.addWidget(self.pushButton_forcast)

        self.pushButton_segment = QPushButton(self.layoutWidget1)
...
"}")
        ...
        self.horizontalLayout_25.addWidget(self.pushButton_segment)

        self.pushButton_pose = QPushButton(self.layoutWidget1)
...
"}")
        ...
        self.horizontalLayout_25.addWidget(self.pushButton_pose)
...
"        }")
        ...
        self.page_forcast = QWidget()
        self.page_forcast.setObjectName(u"page_forcast")
        self.graphicsView = QChartView(self.page_forcast)
        self.graphicsView.setObjectName(u"graphicsView")
        self.graphicsView.setGeometry(QRect(80, 100, 421, 341))
        self.graphicsView_2 = QChartView(self.page_forcast)
        self.graphicsView_2.setObjectName(u"graphicsView_2")
        self.graphicsView_2.setGeometry(QRect(680, 100, 421, 341))
        self.button_jiance = QPushButton(self.page_forcast)
        self.button_jiance.setObjectName(u"button_jiance")
        self.button_jiance.setGeometry(QRect(160, 550, 75, 24))
        self.button_qingchu = QPushButton(self.page_forcast)
        self.button_qingchu.setObjectName(u"button_qingchu")
        self.button_qingchu.setGeometry(QRect(290, 550, 75, 24))
        self.button_yuce = QPushButton(self.page_forcast)
        self.button_yuce.setObjectName(u"button_yuce")
        self.button_yuce.setGeometry(QRect(770, 540, 75, 24))
        self.button_judge = QPushButton(self.page_forcast)
        self.button_judge.setObjectName(u"button_judge")
        self.button_judge.setGeometry(QRect(940, 540, 75, 24))
        self.content.addWidget(self.page_forcast)
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"\u9762\u5411\u6d77\u6d0b\u7267\u573a\u7684\u65e0\u4eba\u7acb\u4f53\u76d1\u6d4b\u7cfb\u7edf", None))
        ...
        self.pushButton_forcast.setText("")
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"\u9c7c\u7c7b\u6570\u91cf", None))
        ...
        self.button_jiance.setText(QCoreApplication.translate("MainWindow", u"\u5f00\u59cb\u76d1\u6d4b", None))
        self.button_qingchu.setText(QCoreApplication.translate("MainWindow", u"\u6e05\u9664\u6570\u636e", None))
        self.button_yuce.setText(QCoreApplication.translate("MainWindow", u"\u9884\u6d4b", None))
        self.button_judge.setText(QCoreApplication.translate("MainWindow", u"\u5224\u5b9a", None))
